...
<body>
<br>
<h1 style="text-align:center">Altar Servers Rota</h1>
<br>
<br>
<?php require_once 'ro_servers_process.php'; ?>
...
<?php
  while ($row = $result->fetch_assoc()): ?>
    <tr>
      ...
      <td>
      <a class="button_edit" href="https://m6f.c42.myftpupload.com/servers/?edit=<?php echo $row['id']; ?>">Edit</a>
<a class="button_delete" href="https://m6f.c42.myftpupload.com/servers-process/?delete=<?php echo $row['id']; ?>">Delete</a>
      </td>
    </tr>
 <?php endwhile; ?>    
</table>
...
<!--Form-->
<form id="forma" class="form-inline" action="https://m6f.c42.myftpupload.com/servers-process/" method="POST">
